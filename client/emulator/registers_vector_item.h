...
public:
    RegistersVectorItem(Das::DB::Device_Item_Type_Manager* mng, QModbusServer* modbus_server, QModbusDataUnit::RegisterType type, const QVector<Das::Device_Item*>& items, QObject* parent = nullptr);
    ...
    Das::DB::Device_Item_Type_Manager* manager() const;
